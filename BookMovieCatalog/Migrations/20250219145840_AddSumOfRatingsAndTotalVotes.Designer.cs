...
namespace BookMovieCatalog.Migrations
{
    ...
    [Migration("20250219145840_AddSumOfRatingsAndTotalVotes")]
    partial class AddSumOfRatingsAndTotalVotes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-12345",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1851dfe4-7c07-42ee-baba-cf0f17ba5985",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN@EXAMPLE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEKIYGIztTF1Jy7iPxWDD5+3A9pZcTUxRPqFXz6qf08ayXRZfreM/ElJSKU+fntlMxA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "869da7e8-f3ec-4bac-bee7-163bd5229da9",
            ...
            modelBuilder.Entity("BookMovieCatalog.Models.Review", b =>
                {
                    ...
                    b.HasOne("BookMovieCatalog.Models.Book", null)
                        .WithMany("Reviews")
                    ...
                    b.HasOne("BookMovieCatalog.Models.Movie", null)
                        .WithMany("Reviews")
