...
namespace BookMovieCatalog.Migrations
{
    ...
    [Migration("20250221000734_FixIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookMovieCatalog.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ProfilePictureUrl")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("https://via.placeholder.com/50");
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-12345",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "915e65c0-1b41-4dc1-b521-8b53ce90a244",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN@EXAMPLE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEKrRlPJLN90dksdCfJoFsFpYnXtMkIlmCB2z2S15HJvlJ7N1nEfk+/bfkSC6hEQGgA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureUrl = "https://via.placeholder.com/50",
                            SecurityStamp = "168a58ec-cee5-4334-a71d-d36ced86e854",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookMovieCatalog.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
